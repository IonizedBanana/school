...
public class BicycleBuilderTester {
   ...
   public static void main(String[] args) {
      ...
      System.out.println("Bicycle's front wheel: Diameter " + b01.getFrontWheel().getDiameter() + " Width: "
            + b01.getFrontWheel().getWidth());
      System.out.println("Bicycle's back wheel: Diameter " + b01.getBackWheel().getDiameter() + " Width: "
            + b01.getBackWheel().getWidth());
      ...
      Bicycle b02 = new Bicycle("Big Wheel", new Wheel(55.0, 2.5), new Wheel(18.0, 2.0),
            new Frame(60.0, "Penny-Farthing"));
